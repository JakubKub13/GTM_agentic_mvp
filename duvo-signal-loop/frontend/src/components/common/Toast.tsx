...
/**
 * App-wide toast host (plan #22). Wrap the app once; consume via `useToast`.
 * Error toasts are assertive `alert`s; informational/success toasts are polite
 * `status`es, so screen readers handle each correctly.
 */
